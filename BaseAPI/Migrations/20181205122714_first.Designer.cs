...
namespace BaseAPI.Migrations
{
    ...
    [Migration("20181205122714_first")]
    partial class first
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BaseAPI.Models.External.Quotes.QuoteItems", b =>
                {
                    b.HasOne("BaseAPI.Models.External.Quotes.Quote")
                        .WithMany("QuoteItems")
            ...
            modelBuilder.Entity("BaseAPI.Models.Internal.Projects.Defaults.Default", b =>
                {
                    b.HasOne("BaseAPI.Models.Internal.Projects.Defaults.DefaultType", "DefaultType")
                        .WithMany("Default")
            ...
            modelBuilder.Entity("BaseAPI.Models.Internal.Projects.Project", b =>
                {
                    ...
                    b.HasOne("BaseAPI.Models.Internal.Projects.ProjectStatus")
                        .WithMany("Projects")
